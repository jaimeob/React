...
let ComponentLayout = (
  ...
  console.log('ComponentLayout props', props)
  ...
  switch (true) {
    ...
    case tipo === 'textocorto' || tipo === 'textolargo': {
      const errorText = (() => {
        if (_.isBoolean(requerido) && _.isEmpty(valor)) {
...
ComponentLayout.propTypes = {
  disableAddComponents: T.bool,
  disableDeleteComponent: T.bool,
  hideTableOptions: T.bool,
  conf: T.shape({
    tipo: T.string,
    value: T.any,
  }),
...
ComponentLayout.defaultProps = {
  ...
  disableAddComponents: false,
  disableDeleteComponent: false,
  conf: {},
  actions: {
...
export function LayoutFormulario(props) {
  const {
    ...
    layoutActions,
    notFoundMessage = '',
    showAddComponentAction = true,
    showDeleteComponentAction = true,
    hideTableOptions = false,
    containerProps = {},
  } = props;
  return (
        ...
        sortBy(components, ['order'])
          .map((cmp, idx) =>
            <ComponentLayout
              ...
              idx={idx}
              order={cmp.order}
              showActionAdd={showAddComponentAction}
              showActionDelete={showDeleteComponentAction}
...
LayoutFormulario.propTypes = {
  showAddComponentAction: T.bool,
  showDeleteComponentAction: T.bool,
  containerProps: T.object,
  // ---
  notFoundMessage: T.string,
  components: T.arrayOf(componentTemplateType),
  hideTableOptions: T.bool,
  // tableOptions: T.shape({
  //   showAddColumnAction: T.bool,
  //   showDeleteColumnAction: T.bool,
  //   showAddGroup: T.bool,
  //   showAddRow: 
  // }),
