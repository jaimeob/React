  ...
  return (
    ...
    >
      ...
      <div className={classes.actions}>
        ...
        { stepper === 0 && permisos.normales.registrar 
          ? (
        ...
        {
          stepper === 1 && permisos.normales.registrar
            ? (
              <Tooltip title="Agregar">
                <IconButton aria-label="Agregarfuncion" onClick={nuevaFuncion} disabled={moduloSoloLectura}>
                  <AgregarIcon />
                </IconButton>
              </Tooltip>
            )
        ...
        <Tooltip title="Activar / Desactivar">
          <div>
            {permisos.especiales.activar || permisos.normales.eliminar || permisos.especiales.descargararchivo ?
