...
const CustomizedDialogDemo = (props) => {
  ...
  const {
    ...
    foo: {
      ...
      handleFileAction,
      handleChangeSelectedEtapaAction,
  ...
  return (
    <div>
      <Dialog
        onClose={handleShowModalEtapaAction}
        aria-labelledby="customized-dialog-title"
        open={showModalEtapa}
        maxWidth="sm"
        fullWidth
      >
        <DialogTitle id="customized-dialog-title" onClose={handleShowModalEtapaAction}>
          <CambiarEtapaIcon 
            className={classNames(classes.leftIcon, classes.fuenteGris)}
          /> <span className={classes.fuenteGris}>Cambiar Etapa</span>
        </DialogTitle>
        <DialogContent>
          <div className={classes.divEtapas}>
            <Typography gutterBottom  className={classes.typographyEtapa}>
              Etapa:
            </Typography>
            <TextField
              ...
              value={selectedEtapa}
              onChange={(e) => handleChangeSelectedEtapaAction(e.target.value)}
              SelectProps={{
                MenuProps: {
            ...
            >
              ...
              {etapas.map(option => (
                <MenuItem key={uniqueId('etapa_')} value={option.EtapaId}>
                  {option.Nombre}
                </MenuItem>
              ))}
            </TextField>
          ...
          <div>
            <TextField
              ...
              onChange={(e) => handleChangeInputAction(6, e)}
              helperText={
                <FormHelperText
          ...
          {permisos.especiales.cargararchivos === 1 ?
            <div>
              ...
              <input
                ...
                onChange={(e) => handleFileAction(1, e)}
                type="file"
              />
              ...
              <FormHelperText>
                {nombreArchivoEtapa || 'Sin archivo...'}
              </FormHelperText>
