      ...
      <View fixed style={styles.header}>
        <View style={styles.header.w80}>
          ...
          <View style={styles.header.sec40}>
            ...
            <Text style={[styles.header.subtitulo, styles.header.negritas]}>Entrada de Almacén</Text>
          </View>
                ...
                <View style={[styles.table, styles.borderNone]}>
                  ...
                  <View style={[styles.tableRow, styles.textLeft]}>
                    ...
                    <View style={[styles.tableCol, styles.w70, styles.borderNone]}>
                      <Text style={[styles.tableCell, styles.header.regularTXT, styles.header.negritas, styles.borderNone, styles.marginNone, styles.paddingLeft]}>VALLE ALTO</Text>
                    </View>
                  </View>
                  <View style={[styles.tableRow, styles.textLeft]}>
                    <View style={[styles.tableCol, styles.w30, styles.borderNone]}>
                      <Text style={[styles.tableCell, styles.header.regularTXT, styles.header.negritas, styles.borderNone, styles.marginNone, styles.paddingLeft]}>Fecha entrada:</Text>
                    </View>
                    <View style={[styles.tableCol, styles.w70, styles.borderNone]}>
                      <Text style={[styles.tableCell, styles.header.regularTXT, styles.header.negritas, styles.borderNone, styles.marginNone, styles.paddingLeft]}>2019-05-08</Text>
                    </View>
                  </View>
                  <View style={[styles.tableRow, styles.textLeft]}>
                    <View style={[styles.tableCol, styles.w30, styles.borderNone]}>
        ...
        <View style={styles.marginT50}>
          <View style={[styles.table, styles.borderNone]}>
            <View style={[styles.tableRow, styles.textCenter]}>
              ...
              <View style={[styles.tableCol, styles.w50, styles.borderNone]}>
                <View><Text style={[styles.text10, styles.marginB]}>Recibido</Text></View>
