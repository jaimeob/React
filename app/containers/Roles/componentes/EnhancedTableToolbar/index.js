      ...
      <div className={classes.actions}>
        ...
        { stepper === 0 ? 
          <Tooltip title="Agregar">
            <div>
              <IconButton aria-label="Agregar" onClick={handleStepper} disabled={moduloSoloLectura}>
                <AgregarIcon />
              </IconButton>
            </div>
          </Tooltip> :
        ...
        <Tooltip title="Activar / Desactivar">
          <div>
            <IconButton aria-label="Activar / Desactivar" disabled={numSelected < 1 || moduloSoloLectura}  onClick={handleToggleMenuContextual}>
              <MoreVertIcon />
            </IconButton>
