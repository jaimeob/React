...
class EnhancedTable extends React.Component {
  ...
  showIconPorcent = (propName, value) => {
    if (propName ==='Porcentaje') {
      if(value > 0){
        return <TrendingUp style={{color: GreenColor[700], width: 15, height: 15}}/>
      }
      if(value < 0){
        return <TrendingDown style={{color: RedColor[700], width: 15, height: 15}}/>
      }
      return <TrendingFlat style={{color: YellowColor[700], width: 15, height: 15}}/>
    }
    return null;
  }
  ...
  showMessageEmpty = (classes, rows, emptyRows, progress) =>
    rows.length <= 0 ?
      <TableBody>
        <TableRow style={{ height: 49 * emptyRows }}>
          {progress ?
            ...
            <TableCell colSpan={6} align='center'>
              ...
              />
              <Typography variant="h6" className={classes.empty}>
                Una vez que se encuentre información, se mostrarán en este apartado.
              </Typography>
            </TableCell>
          }
        </TableRow>
            ...
            <div className={classes.tableWrapper}>
              ...
              >
                ...
                {dataTable.length > 0 ?
                  ...
                  :
                  this.showMessageEmpty(classes, rows, emptyRows, progress)
                }
              </Table>
            </div>
            {/* <TablePagination
