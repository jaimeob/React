        ...
        <Grid item xs={12}>
          ...
          <div className={classes.textContainer}>
            <Typography className={classes.text}>
                Una vez que se agregen indicadores se visualizarán en este apartado.
            </Typography>
            <Typography className={classes.text}>
                Para registrar un indicador debe dar clic en el botón.
            </Typography>
          </div>
          <Button 
            variant="contained" 
          ...
          >
            <AddIcon className={classes.icon}/> Registrar Indicador
          </Button>
        </Grid>
      </Grid>
    </Paper>
