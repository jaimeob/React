    ...
    >
      ...
      <div className={classes.actions}>
        ...
        <Tooltip title="Buscar">
          <IconButton aria-label="Buscar" onClick={handleToggleSearch}>
            { openSearch 
              ? ( <CerrarIcon /> ) 
              : ( <SearchIcon /> )
            }
        ...
        <Tooltip title="Filtros">
          <IconButton aria-label="Filtros" onClick={handleToggle} >
            <FilterListIcon />
          </IconButton>
        </Tooltip>
        ...
        {permisos.normales.eliminar===1 || permisos.especiales.activar===1 ?
