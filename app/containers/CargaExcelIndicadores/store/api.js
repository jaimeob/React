...
export const getListGeneralApi = (tipoCargaId, empresaId, anio, plazaId) => {
  const req = Object.assign({
    method: 'GET',
    url: `/cargaexcelindicadores/obtenerListadoCargas/${tipoCargaId}/${empresaId}/${anio}/${plazaId}`,
    data:{},
  })
...
export const getPlazasGeneralApi = (IdPlaza) => {
  const req = Object.assign({
    method: 'GET',
