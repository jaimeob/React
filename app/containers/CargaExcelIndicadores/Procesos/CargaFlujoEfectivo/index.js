...
export class CargaFlujoEfectivo extends Component {
  componentDidMount() {
    const {
      actions: {
    ...
    /*
      TODO:
        tipoCargaId: 4 = Flujo Efectivo,
        periodicity: 'S' = Semanal
    */
    defaultConfigurationAction();
    initialConfigurationAction(4, 'S');
  }
  ...
  render() {
    ...
    return (
      <div>
        <Helmet>
          <title>CargaFlujoEfectivo</title>
          <meta
            name="description"
            content="Description of CargaFlujoEfectivo"
          />
        </Helmet>
        <Spinner />
        <Appbar texto="Carga Flujo de Efectivo"></Appbar>
