...
export class CargaPlaneacionCreditoPuente extends Component {
  componentDidMount() {
    const {
      actions: {
    ...
    /*
      TODO:
        tipoCargaId: 11 = Planeación Crédito Puente,
        periodicity: 'S' = Semanal
    */
    defaultConfigurationAction();
    initialConfigurationAction(11, 'S');
  }
  ...
  render() {
    ...
    return (
      <div>
        <Helmet>
          <title>CargaPlaneacionCreditoPuente</title>
          <meta
            name="description"
            content="Description of CargaPlaneacionCreditoPuente"
          />
        </Helmet>
        <Spinner />
        <Appbar texto="Carga Planeación Crédito Puente"></Appbar>
...
CargaPlaneacionCreditoPuente.propTypes = {
