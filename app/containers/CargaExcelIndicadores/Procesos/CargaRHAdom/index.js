...
export class CargaRHAdom extends Component {
  componentDidMount() {
    const {
      actions: {
    ...
    /*
      TODO:
        tipoCargaId: 5 = RH Admon,
        periodicity: 'M' = Mensual
    */
    defaultConfigurationAction();
    initialConfigurationAction(5, 'M');
  }
  ...
  render() {
    ...
    return (
      <div>
        <Helmet>
          <title>CargaRHAdom</title>
          <meta
            name="description"
            content="Description of CargaRHAdom"
          />
        </Helmet>
        <Spinner />
        <Appbar texto="Carga RH Administración Correcta de Presupuesta de Nómina"></Appbar>
