...
export class CargaBuroCredito extends Component {
  componentDidMount() {
    const {
      actions: {
    ...
    /*
      TODO:
        tipoCargaId: 2 = Buro de Crédito,
        periodicity: 'M' = Mensual
    */
    defaultConfigurationAction();
    initialConfigurationAction(2, 'M');
  }
  ...
  render() {
    ...
    return (
      <div>
        <Helmet>
          <title>CargaBuroCredito</title>
          <meta
            name="description"
            content="Description of CargaBuroCredito"
          />
        </Helmet>
        <Spinner />
        <Appbar texto="Carga Buro de Crédito"></Appbar>
