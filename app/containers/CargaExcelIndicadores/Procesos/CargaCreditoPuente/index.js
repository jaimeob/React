...
export class CargaCreditoPuente extends Component {
  componentDidMount() {
    const {
      actions: {
    ...
    /* TODO:
        tipoCargaId: 10 = Flujo Efectivo,
        periodicity: 'S' = Semanal
    */
    defaultConfigurationAction();
    initialConfigurationAction(10, 'S');
  }
  ...
  render() {
    ...
    return (
      <div>
        <Helmet>
          <title>CargaCreditoPuente</title>
          <meta
            name="description"
            content="Description of CargaCreditoPuente"
          />
        </Helmet>
        <Spinner />
        <Appbar texto="Carga De Crédito Puente"></Appbar>
