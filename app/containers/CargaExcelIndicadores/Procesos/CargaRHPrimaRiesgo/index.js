...
export class CargaRHPrimaRiesgo extends Component {
  componentDidMount() {
    const {
      actions: {
    ...
    /* TODO:
        tipoCargaId: 6 = RH Prima Riesgo,
        periodicity: 'D' = Diario
    */
    defaultConfigurationAction();
    initialConfigurationAction(6, 'D');
  }
  ...
  render() {
    ...
    return (
      <div>
        <Helmet>
          <title>CargaRHPrimaRiesgo</title>
          <meta
            name="description"
            content="Description of CargaRHPrimaRiesgo"
          />
        </Helmet>
        <Spinner />
        <Appbar texto="Carga RH Prima de Riesgo"></Appbar>
