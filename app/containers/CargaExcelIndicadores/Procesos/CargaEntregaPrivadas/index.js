...
export class CargaEntregaPrivadas extends Component {
  componentDidMount() {
    const {
      actions: {
    ...
    /* TODO:
        tipoCargaId: 8 = Entrega de Privadas,
        periodicity: 'D' = Diario
    */
    defaultConfigurationAction();
    initialConfigurationAction(8, 'D');
  }
  ...
  render() {
    ...
    return (
      <div>
        <Helmet>
          <title>CargaEntregaPrivadas</title>
          <meta
            name="description"
            content="Description of CargaEntregaPrivadas"
          />
        </Helmet>
        <Spinner />
        <Appbar texto="Carga Entrega de Privadas"></Appbar>
...
CargaEntregaPrivadas.propTypes = {
