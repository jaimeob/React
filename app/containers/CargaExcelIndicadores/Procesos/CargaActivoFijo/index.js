...
export class CargaActivoFijo extends Component {
  componentDidMount() {
    const {
      actions: {
    ...
    /* TODO:
        tipoCargaId: 7 = Activo Fijo,
        periodicity: 'D' = Diario
    */
    defaultConfigurationAction();
    initialConfigurationAction(7, 'D');
  }
  ...
  render() {
    ...
    return (
      <div>
        <Helmet>
          <title>CargaActivoFijo</title>
          <meta
            name="description"
            content="Description of CargaActivoFijo"
          />
        </Helmet>
        <Spinner />
        <Appbar texto="Carga Activo Fijo"></Appbar>
