/**
 *
 * CargaProyectoAutorizadoATiempo
 *
 */
...
export class CargaProyectoAutorizadoATiempo extends Component {
  componentDidMount() {
    const {
      actions: {
    ...
    /* TODO:
        tipoCargaId: 9 = Proyecto Autorizado a Tiempo,
        periodicity: 'D' = Diario
    */
    defaultConfigurationAction();
    initialConfigurationAction(9, 'D');
  }
  ...
  onFocusChange = () => {
    ...
    setFocusedDayAction(!focusedDay);
  }
  ...
  render() {
    ...
    const propsFileHeader = {
      ...
      weekCurrent,
      propsDay: {
        initialDate: `${yearCurrent || 1990}-01-01`,
        selectedDay,
        focusedDay,
        onDateChange: this.onDateChange,
        onFocusChange: this.onFocusChange,
      },
      itemsDisabled: listGeneral.length > 0 ? listGeneral.map(list => list.Periodo) : [],
    };
    ...
    return (
      <div>
        <Helmet>
          <title>CargaProyectoAutorizadoATiempo</title>
          <meta
            name="description"
            content="Description of CargaProyectoAutorizadoATiempo"
          />
        </Helmet>
        <Spinner />
        <Appbar texto="Carga De Proyecto Autorizado a Tiempo"></Appbar>
...
CargaProyectoAutorizadoATiempo.propTypes = {
