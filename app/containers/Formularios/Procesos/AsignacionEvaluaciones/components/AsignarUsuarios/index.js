      ...
      <OH>
        <Container style={{paddingBottom: 15}}>
          <Typography variant="h6" color="primary" style={{flexGrow: 1, textTransform: 'none', paddingLeft: 15, paddingTop: 15}}> 
            {
              stepper === 1 ? `Usuarios evaluadores de ${ NombreUsuario }` : 'Usuarios a evaluar'
            }
          </Typography>
          ...
          <OH>
            <Tabla
              ...
              opciones = {
                [
                  {...(tipoFormulario === 'REFEVA' && stepper === 0 ?  {'icon' : 'informacion', 'message' : 'Es necesario capturar al menos un usuario evaluador..', 'action' : (IdAsignacion) => asignarUsuariosAction(IdAsignacion)} : null )},
                  {...(tipoFormulario === 'REFEVA' && stepper === 0 ?  {'icon' : 'ver', 'action' : (IdAsignacion) => asignarUsuariosAction(IdAsignacion)} : null), 'gris' : true},
