...
export class AsignacionEvaluaciones extends React.Component {
  componentWillMount() {
    const {
      actions: {
...
AsignacionEvaluaciones.propTypes = {
  actions: T.object,
  asignacionEvaluaciones: T.object,
  permisos: T.object, 
};

const mapStateToProps = createStructuredSelector({
  asignacionEvaluaciones: makeSelectFormulario(),
});
...
const withReducer = injectReducer({ key: 'asignacionEvaluaciones', reducer });
const withSaga = injectSaga({ key: 'asignacionEvaluaciones', saga, mode:DAEMON});
