...
export class AsignacionFormularios extends React.Component {
  componentWillMount() {
    const {
      actions: {
...
AsignacionFormularios.propTypes = {
  actions: T.object,
  asignacionFormulario: T.object,
  permisos: T.object, 
};

const mapStateToProps = createStructuredSelector({
  asignacionFormulario: makeSelectFormulario(),
});
...
const withReducer = injectReducer({ key: 'asignacionFormulario', reducer });
const withSaga = injectSaga({ key: 'asignacionFormulario', saga, mode:DAEMON});
