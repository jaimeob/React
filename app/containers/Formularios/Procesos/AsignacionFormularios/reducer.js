...
function asignacionFormularioReducer(state = initialState, action) {
  switch (action.type) {
    case DEFAULT:{
      return state;
    }
    ...
    case ON_INPUT_CHANGE: {
      ...
      if (campo === 2) {
        return state.setIn(['asignacionTabla', 'nuevaAsignacion', 'campos', id, 'valor'], fromJS(valor))
          ...
          .setIn(['asignacionTabla', 'nuevaAsignacion','requiereValidacion'], valor.requiereValidacion)
      }
...
export default asignacionFormularioReducer;
