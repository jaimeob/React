...
export const FormatoConteoPDF = (props) => {
  ...
  piezas.forEach((pieza) => {
    registros.push({id: 1, planta: pieza.planta, seccion: pieza.seccion, idInsumo: pieza.idPieza, insumo: pieza.nombre, identificador: pieza.pieza, tipo: 'PZA', cantidad: pieza.cantPiezas,cantidadReal:''})
  })
  // }
  // if (!isUndefined(accesorios)){
  accesorios.forEach((accesorio) => {
    registros.push({id: 1, planta: accesorio.planta, seccion: accesorio.seccion, idInsumo: accesorio.idAccesorio, insumo: accesorio.nombre,identificador: '',tipo: 'ACC', cantidad: accesorio.cantPiezas,cantidadReal:''})
  })
  // }
        ...
        <View fixed style={styles.header}>
          ...
          <View style={styles.table}>
            <View style={[styles.tableRow, styles.header.negritas, styles.textCenter]}>
              ...
              <View style={[styles.tableCol, styles.w25, styles.borders]}>
              ...
              <View style={[styles.tableCol, styles.w9, styles.borders]}>
                <Text style={[styles.tableCell, styles.marginNone]}>Cantidad teórica</Text>
              </View>
              <View style={[styles.tableCol, styles.w9, styles.borders]}>
                <Text style={[styles.tableCell, styles.marginNone]}>Cantidad fisica</Text>
              </View>
            </View>
          </View>
        </View>
              ...
              return(
                <View style={styles.table}>
                  <View style={styles.tableRow}>
                    ...
                    <View style={[styles.tableCol, styles.w25, styles.textLeft, styles.paddingLeft, styles.borders]}>
                    ...
                    <View style={[styles.tableCol, styles.w9, styles.textCenter, styles.borders]}>
                      <Text style={[styles.tableCell, styles.marginNone]}>{registro.cantidad}</Text>
                    </View>
                    <View style={[styles.tableCol, styles.w9, styles.textCenter, styles.borders]}>
                      <Text style={[styles.tableCell, styles.marginNone]}>{registro.cantidadReal}</Text>
                    </View>
                  </View>
