...
export const MyDocument = (props) => {
  ...
  const generales = datos[0][0]
  const registros = datos[1]
  let cantidad = 0;
  let costo = 0;
  let importe = 0;
        ...
        <View fixed style={styles.header}>
          <View style={styles.header.w80}>
            ...
            <View style={styles.header.sec40}>
              ...
              <Text style={[styles.header.subtitulo, styles.header.negritas]}>Movimiento de almacén</Text>
            </View>
            {/* FECHA Y HORA */}
            <View style={styles.header.sec30}>
                ...
                <View style={styles.table}>
                  <View style={styles.tableRow}>
                    <View style={[styles.tableCol, styles.w10, styles.textCenter]}>
                      <Text style={[styles.tableCell, styles.marginNone]}>{registro.IdMovimientoAlmacenDetalle}</Text>
                    </View>
