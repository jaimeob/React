// Mantenimientos programados detalle
...
export const MantenimientosPDF = (props) => {
  const {
    registros,
  } = props;

  const NombrePlaza = registros.length>0 ? registros[0].NombrePlaza : '';
  const Inventario = registros.length>0 ? registros[0].Almacen : '';
        ...
        <View fixed style={[styles.header, styles.marginB]}>
          <View style={styles.header.w80}>
            ...
            <View style={styles.header.sec40}>
              ...
              <Text style={[styles.header.subtitulo, styles.header.negritas]}>DETALLE DE MANTENIMIENTOS</Text>
            </View>
        ...
        <View fixed style={styles.header}>
          ...
          <View style={styles.table}>
            <View style={[styles.tableRow, styles.header.negritas, styles.textCenter]}>
              ...
              <View style={[styles.tableCol, styles.w10, styles.borders]}>
                <Text style={[styles.tableCell, styles.marginNone]}>Fecha creacion</Text>
              </View>
              <View style={[styles.tableCol, styles.w10, styles.borders]}>
                <Text style={[styles.tableCell, styles.marginNone]}>Fecha mantenimiento</Text>
              </View>
            </View>
          </View>
        </View>
                ...
                <View style={styles.table}>
                  <View style={styles.tableRow}>
                    ...
                    <View style={[styles.tableCol, styles.w8, styles.textCenter]}>
                      <Text style={[styles.tableCell, styles.marginNone]}>{registro.NombrePlanta}</Text>
                    </View>
                    ...
                    <View style={[styles.tableCol, styles.w22, styles.textLeft, styles.paddingLeft]}>
                    ...
                    <View style={[styles.tableCol, styles.w7, styles.textCenter]}>
                      <Text style={[styles.tableCell, styles.marginNone]}>{registro.Usos}</Text>
                    </View>
                    <View style={[styles.tableCol, styles.w10, styles.textCenter]}>
                      <Text style={[styles.tableCell, styles.marginNone]}>{registro.FechaCreacion}</Text>
                    </View>
                    <View style={[styles.tableCol, styles.w10, styles.textCenter]}>
                      <Text style={[styles.tableCell, styles.marginNone]}>{registro.FechaMantenimiento}</Text>
                    </View>
                  </View>
...
export class PDFF extends React.Component {
