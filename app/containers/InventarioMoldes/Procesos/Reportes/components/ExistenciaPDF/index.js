...
export const ExistenciaPDF  = (props) => {
  const {
    registros,
    valorPlaza,
    valorAlmacen,
  ...
  return (
    <Document>
      <Page wrap style={styles.body}>
        ...
        <View fixed style={[styles.header, styles.marginB]}>
          <View style={styles.header.w80}>
            ...
            <View style={styles.header.sec40}>
              ...
              <Text style={[styles.header.subtitulo, styles.header.negritas]}>Existencia de inventario</Text>
            </View>
        ...
        <View style={[styles.table]}>
          <View style={[styles.tableRow, styles.textLeft]}>
            <View style={[styles.tableCol, styles.w100, styles.borders]}>
              <View style={[styles.tableRow, styles.textLeft]}>
                <View style={[styles.tableCol, styles.w12, styles.borderNone]}>
                  <Text style={[styles.tableCell, styles.header.regularTXT, styles.header.negritas, styles.marginNone, styles.paddingLeft, styles.borderNone]}>Tipo Insumos:</Text>
                </View>
                <View style={[styles.tableCol, styles.w88, styles.borderNone]}>
                  <Text style={[styles.tableCell, styles.marginNone, styles.paddingLeft, styles.borderNone]}>Piezas</Text>
                </View>
              </View>
            </View>
          </View>
              ...
              return(
                <View style={styles.table}>
                  <View style={styles.tableRow}>
                    ...
                    <View style={[styles.tableCol, styles.w14, styles.textLeft, styles.paddingLeft]}>
        ...
        <View style={[styles.table, styles.borderleftN]}>
          <View style={styles.tableRow}>
            <View style={[styles.tableCol, styles.borderNone, styles.w13, styles.textCenter]}>
            ...
            <View style={[styles.tableCol, styles.borderNone, styles.w14, styles.textLeft, styles.paddingLeft]}>
              <Text style={[styles.tableCell, styles.marginNone]}></Text>
            </View>
            <View style={[styles.tableCol, styles.borderNone, styles.w7, styles.textCenter]}>
              <Text style={[styles.tableCell, styles.marginNone]}></Text>
            </View>
            <View style={[styles.tableCol, styles.borderNone, styles.w22, styles.textCenter]}>
              <Text style={[styles.tableCell, styles.marginNone]}></Text>
            </View>
            <View style={[styles.tableCol, styles.borderNone, styles.w8, styles.textCenter, styles.borderRight]}>
              <Text style={[styles.tableCell, styles.marginNone]}></Text>
            </View>
            <View style={[styles.tableCol, styles.w8, styles.textCenter, styles.borderBottom]}>
            ...
            <View style={[styles.tableRow, styles.textLeft]}>
              <View style={[styles.tableCol, styles.w100, styles.borders]}>
                <View style={[styles.tableRow, styles.textLeft]}>
                  ...
                  <View style={[styles.tableCol, styles.w88, styles.borderNone]}>
                    <Text style={[styles.tableCell, styles.marginNone, styles.paddingLeft, styles.borderNone]}>Accesorios</Text>
                  </View>
                </View>
              </View>
            </View>
