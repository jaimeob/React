...
const componentTemplateType = T.shape({
  ...
  dataType: T.string.isRequired,
  textAlign: T.string.isRequired,
  placeholder: T.string.isRequired,
  valor: T.string.isRequired,
  requerido: T.bool.isRequired,
  longitudMinima: T.string.isRequired,
  longitudMaxima: T.string.isRequired,
  icon: T.string.isRequired,
  opciones: T.arrayOf(
    T.shape({
      label: T.string.isRequired,
      valor: T.any.isRequired,
      icon: T.string.isRequired,
    })
  ),
  files: T.arrayOf(
...
// const ALL_ACTIONS = Actions.getAll();
// const FormsLayout = function FormsLayout(props) {
